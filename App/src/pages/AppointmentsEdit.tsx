  ...
  const AppointmentsEdit: React.FC = () => {
    ...
    return (
      <IonPage>
        <IonHeader>
          <IonToolbar>
            <IonTitle>Información de cita</IonTitle>
          </IonToolbar>
        </IonHeader>
            ...
            cita && (
              <IonList className="p-6 space-y-6">
                <IonCard className="bg-blue-50">
                  <IonCardHeader>
                    <IonLabel className="text-lg font-bold text-blue-500">Fecha</IonLabel>
                  </IonCardHeader>
                ...
                <IonCard className="bg-blue-50">
                  <IonCardHeader>
                    <IonLabel className="text-lg font-bold text-blue-500">Hora</IonLabel>
                  </IonCardHeader>
                ...
                <IonCard className="bg-blue-50">
                  <IonCardHeader>
                    <IonLabel className="text-lg font-bold text-blue-500">Veterinario ID</IonLabel>
                  </IonCardHeader>
